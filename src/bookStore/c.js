const cStore = [{
  ...
  key: 'c/c++',
  name: 'C++标准库第2版',
  url: 'https://pan.baidu.com/s/1WqKGApoyUDGNxeMG_5rGDw'
}, {
  img: '21天学通c++.jpg',
  key: 'c/c++',
  name: '21天学通c++',
  url: 'https://pan.baidu.com/s/1IR3e9ZypuKJNlRRKdih4Eg'
}, {
  img: 'C和C++安全编码.jpg',
  key: 'c/c++',
  name: 'C和C++安全编码',
  url: 'https://pan.baidu.com/s/1JEIOj_nLqFNnm3TRptkdag'
}, {
  img: '应用密码学：协议、算法与C源程序.jpg',
  key: 'c/c++',
  name: '应用密码学：协议、算法与C源程序',
  url: 'https://pan.baidu.com/s/1prSROI_-L15l6uVmb8CVfg'
}, {
  img: 'C++程序设计语言.jpg',
  key: 'c/c++',
  name: 'C++程序设计语言(十周年纪念版)',
  url: 'https://pan.baidu.com/s/1CaYwja35mh2NtO85JIOWLQ'
}, {
  img: 'C++primer.jpg',
  key: 'c/c++',
  name: 'C++ Primer中文版',
  url: 'https://pan.baidu.com/s/15dWvzKwMZi2OMe9igecoMA'
}, {
  img: 'C和指针.jpg',
  key: 'c/c++',
  name: 'C和指针',

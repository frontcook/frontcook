...
* [嵌入式 Linux 知识库](https://www.gitbook.com/book/tinylab/elinux/details)
...
* [Real-Time Rendering 3rd](https://github.com/QianMo/Real-Time-Rendering-3rd-Summary-Ebook)
...
* Google Material Design中文版 ([译本一](https://wcc723.gitbooks.io/google_design_translate/content/style-icons.html) [译本二](https://github.com/1sters/material_design_zh))
...
* [Network programming with Go 中文版](https://github.com/astaxie/NPWG_zh)
...
* [Stanford 公开课](https://github.com/x140yu/Developing_iOS_8_Apps_With_Swift)
